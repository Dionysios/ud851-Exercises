...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // instantiate a new instance variable for your ChargingBroadcastReceiver
        // and an IntentFilter
    ...
    //  a new method called showCharging which takes a boolean. This method should
    ...
    //ass called ChargingBroadcastReceiver that extends BroadcastReceiver
        // o get the action from the intent and see if it matches the
        // Intent.ACTION_POWER_CONNECTED. If it matches, it's charging. If it doesn't match, it's not
        // charging.
        //  using the showCharging method you wrote
}